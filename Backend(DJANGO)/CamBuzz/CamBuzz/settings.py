"""
Django settings for CamBuzz project.
...
WSGI_APPLICATION = 'CamBuzz.wsgi.application'
...
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD')  # Your Gmail password or app-specific password
